...
#include "mps_interfaces/srv/detail/get_inflated_map__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = mps_interfaces::srv::GetInflatedMap_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const mps_interfaces::srv::GetInflatedMap_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<mps_interfaces::srv::GetInflatedMap_Request *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _GetInflatedMap_Request__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const mps_interfaces::srv::GetInflatedMap_Request *>(
...
static size_t _GetInflatedMap_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_GetInflatedMap_Request(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _GetInflatedMap_Request__callbacks = {
  "mps_interfaces::srv",
...
static rosidl_message_type_support_t _GetInflatedMap_Request__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_GetInflatedMap_Request__callbacks,
...
{
  return &mps_interfaces::srv::typesupport_fastrtps_cpp::_GetInflatedMap_Request__handle;
}
...
{
bool cdr_serialize(
  const map_interfaces::msg::GeometricMap &,
...
size_t get_serialized_size(
  ...
  size_t current_alignment);
size_t
max_serialized_size_GeometricMap(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment);
}  // namespace typesupport_fastrtps_cpp
  ...
  size_t current_alignment)
{
  ...
  // Member: inflated_map
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        map_interfaces::msg::typesupport_fastrtps_cpp::max_serialized_size_GeometricMap(
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = mps_interfaces::srv::GetInflatedMap_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const mps_interfaces::srv::GetInflatedMap_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<mps_interfaces::srv::GetInflatedMap_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _GetInflatedMap_Response__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const mps_interfaces::srv::GetInflatedMap_Response *>(
...
static size_t _GetInflatedMap_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_GetInflatedMap_Response(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _GetInflatedMap_Response__callbacks = {
  "mps_interfaces::srv",
...
static rosidl_message_type_support_t _GetInflatedMap_Response__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_GetInflatedMap_Response__callbacks,
  get_message_typesupport_handle_function,
};
...
{
  return &mps_interfaces::srv::typesupport_fastrtps_cpp::_GetInflatedMap_Response__handle;
}
...
static service_type_support_callbacks_t _GetInflatedMap__callbacks = {
  "mps_interfaces::srv",
  "GetInflatedMap",
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, mps_interfaces, srv, GetInflatedMap_Request)(),
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, mps_interfaces, srv, GetInflatedMap_Response)(),
...
static rosidl_service_type_support_t _GetInflatedMap__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_GetInflatedMap__callbacks,
...
{
  return &mps_interfaces::srv::typesupport_fastrtps_cpp::_GetInflatedMap__handle;
}
