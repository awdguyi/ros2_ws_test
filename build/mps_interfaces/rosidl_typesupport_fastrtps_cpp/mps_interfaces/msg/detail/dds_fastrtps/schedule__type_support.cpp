...
#include "mps_interfaces/msg/detail/schedule__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  // Member: etas
  {
    ...
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
    size_t item_size = sizeof(ros_message.etas[0]);
    current_alignment += array_size * item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = mps_interfaces::msg::Schedule;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const mps_interfaces::msg::Schedule *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<mps_interfaces::msg::Schedule *>(
    untyped_ros_message);
...
{
  return &mps_interfaces::msg::typesupport_fastrtps_cpp::_Schedule__handle;
}
