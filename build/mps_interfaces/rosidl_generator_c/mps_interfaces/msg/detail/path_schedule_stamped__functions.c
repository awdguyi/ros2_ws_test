...
mps_interfaces__msg__PathScheduleStamped__init(mps_interfaces__msg__PathScheduleStamped * msg)
{
  ...
  if (!std_msgs__msg__Header__init(&msg->header)) {
    mps_interfaces__msg__PathScheduleStamped__fini(msg);
    return false;
  }
  // path_schedule
  if (!mps_interfaces__msg__PathSchedule__init(&msg->path_schedule)) {
    mps_interfaces__msg__PathScheduleStamped__fini(msg);
    return false;
  }
  return true;
...
mps_interfaces__msg__PathScheduleStamped__fini(mps_interfaces__msg__PathScheduleStamped * msg)
{
  ...
  // path_schedule
  mps_interfaces__msg__PathSchedule__fini(&msg->path_schedule);
}
...
mps_interfaces__msg__PathScheduleStamped__are_equal(const mps_interfaces__msg__PathScheduleStamped * lhs, const mps_interfaces__msg__PathScheduleStamped * rhs)
{
  ...
  // path_schedule
  if (!mps_interfaces__msg__PathSchedule__are_equal(
...
mps_interfaces__msg__PathScheduleStamped__create()
{
  ...
  mps_interfaces__msg__PathScheduleStamped * msg = (mps_interfaces__msg__PathScheduleStamped *)allocator.allocate(sizeof(mps_interfaces__msg__PathScheduleStamped), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(mps_interfaces__msg__PathScheduleStamped));
  bool success = mps_interfaces__msg__PathScheduleStamped__init(msg);
  if (!success) {
...
mps_interfaces__msg__PathScheduleStamped__Sequence__init(mps_interfaces__msg__PathScheduleStamped__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  mps_interfaces__msg__PathScheduleStamped * data = NULL;

  if (size) {
    data = (mps_interfaces__msg__PathScheduleStamped *)allocator.zero_allocate(size, sizeof(mps_interfaces__msg__PathScheduleStamped), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = mps_interfaces__msg__PathScheduleStamped__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        mps_interfaces__msg__PathScheduleStamped__fini(&data[i - 1]);
      }
...
mps_interfaces__msg__PathScheduleStamped__Sequence__fini(mps_interfaces__msg__PathScheduleStamped__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      mps_interfaces__msg__PathScheduleStamped__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  mps_interfaces__msg__PathScheduleStamped__Sequence * array = (mps_interfaces__msg__PathScheduleStamped__Sequence *)allocator.allocate(sizeof(mps_interfaces__msg__PathScheduleStamped__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = mps_interfaces__msg__PathScheduleStamped__Sequence__init(array, size);
  if (!success) {
...
mps_interfaces__msg__PathScheduleStamped__Sequence__destroy(mps_interfaces__msg__PathScheduleStamped__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    mps_interfaces__msg__PathScheduleStamped__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
mps_interfaces__msg__PathScheduleStamped__Sequence__are_equal(const mps_interfaces__msg__PathScheduleStamped__Sequence * lhs, const mps_interfaces__msg__PathScheduleStamped__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!mps_interfaces__msg__PathScheduleStamped__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  mps_interfaces__msg__PathScheduleStamped__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(mps_interfaces__msg__PathScheduleStamped);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    mps_interfaces__msg__PathScheduleStamped * data =
      (mps_interfaces__msg__PathScheduleStamped *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!mps_interfaces__msg__PathScheduleStamped__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          mps_interfaces__msg__PathScheduleStamped__fini(&output->data[i]);
        }
        return false;
      }
    }
