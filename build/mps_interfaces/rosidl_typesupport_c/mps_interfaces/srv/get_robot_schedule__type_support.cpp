...
static const _GetRobotSchedule_Request_type_support_symbol_names_t _GetRobotSchedule_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, mps_interfaces, srv, GetRobotSchedule_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, mps_interfaces, srv, GetRobotSchedule_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, mps_interfaces, srv, GetRobotSchedule_Request)() {
  return &::mps_interfaces::srv::rosidl_typesupport_c::GetRobotSchedule_Request_message_type_support_handle;
}
...
static const _GetRobotSchedule_Response_type_support_symbol_names_t _GetRobotSchedule_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, mps_interfaces, srv, GetRobotSchedule_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, mps_interfaces, srv, GetRobotSchedule_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, mps_interfaces, srv, GetRobotSchedule_Response)() {
  return &::mps_interfaces::srv::rosidl_typesupport_c::GetRobotSchedule_Response_message_type_support_handle;
}
...
static const _GetRobotSchedule_type_support_symbol_names_t _GetRobotSchedule_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, mps_interfaces, srv, GetRobotSchedule)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, mps_interfaces, srv, GetRobotSchedule)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, mps_interfaces, srv, GetRobotSchedule)() {
  return &::mps_interfaces::srv::rosidl_typesupport_c::GetRobotSchedule_service_type_support_handle;
}
