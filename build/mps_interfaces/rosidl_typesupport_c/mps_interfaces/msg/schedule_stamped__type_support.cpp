...
static const _ScheduleStamped_type_support_symbol_names_t _ScheduleStamped_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, mps_interfaces, msg, ScheduleStamped)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, mps_interfaces, msg, ScheduleStamped)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, mps_interfaces, msg, ScheduleStamped)() {
  return &::mps_interfaces::msg::rosidl_typesupport_c::ScheduleStamped_message_type_support_handle;
}
