...
static const _PathSchedule_type_support_symbol_names_t _PathSchedule_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, mps_interfaces, msg, PathSchedule)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, mps_interfaces, msg, PathSchedule)),
  }
};
...
{
  return &::mps_interfaces::msg::rosidl_typesupport_cpp::PathSchedule_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, mps_interfaces, msg, PathSchedule)() {
  return get_message_type_support_handle<mps_interfaces::msg::PathSchedule>();
}
