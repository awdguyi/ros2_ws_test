...
static const _PolygonObjectArrayStamped_type_support_symbol_names_t _PolygonObjectArrayStamped_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, map_interfaces, msg, PolygonObjectArrayStamped)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, map_interfaces, msg, PolygonObjectArrayStamped)),
  }
};
...
{
  return &::map_interfaces::msg::rosidl_typesupport_cpp::PolygonObjectArrayStamped_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, map_interfaces, msg, PolygonObjectArrayStamped)() {
  return get_message_type_support_handle<map_interfaces::msg::PolygonObjectArrayStamped>();
}
