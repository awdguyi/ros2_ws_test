...
map_interfaces__msg__PolygonObjectArray__init(map_interfaces__msg__PolygonObjectArray * msg)
{
  ...
  // polygon_objects
  if (!map_interfaces__msg__PolygonObject__Sequence__init(&msg->polygon_objects, 0)) {
    map_interfaces__msg__PolygonObjectArray__fini(msg);
    return false;
  }
  return true;
}
...
map_interfaces__msg__PolygonObjectArray__fini(map_interfaces__msg__PolygonObjectArray * msg)
{
  ...
  // polygon_objects
  map_interfaces__msg__PolygonObject__Sequence__fini(&msg->polygon_objects);
}
...
map_interfaces__msg__PolygonObjectArray__are_equal(const map_interfaces__msg__PolygonObjectArray * lhs, const map_interfaces__msg__PolygonObjectArray * rhs)
{
  ...
  // polygon_objects
  if (!map_interfaces__msg__PolygonObject__Sequence__are_equal(
  ...
  map_interfaces__msg__PolygonObjectArray * output)
{
  ...
  // polygon_objects
  if (!map_interfaces__msg__PolygonObject__Sequence__copy(
...
map_interfaces__msg__PolygonObjectArray__create()
{
  ...
  map_interfaces__msg__PolygonObjectArray * msg = (map_interfaces__msg__PolygonObjectArray *)allocator.allocate(sizeof(map_interfaces__msg__PolygonObjectArray), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(map_interfaces__msg__PolygonObjectArray));
  bool success = map_interfaces__msg__PolygonObjectArray__init(msg);
  if (!success) {
...
map_interfaces__msg__PolygonObjectArray__Sequence__init(map_interfaces__msg__PolygonObjectArray__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  map_interfaces__msg__PolygonObjectArray * data = NULL;

  if (size) {
    data = (map_interfaces__msg__PolygonObjectArray *)allocator.zero_allocate(size, sizeof(map_interfaces__msg__PolygonObjectArray), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = map_interfaces__msg__PolygonObjectArray__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        map_interfaces__msg__PolygonObjectArray__fini(&data[i - 1]);
      }
...
map_interfaces__msg__PolygonObjectArray__Sequence__fini(map_interfaces__msg__PolygonObjectArray__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      map_interfaces__msg__PolygonObjectArray__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  map_interfaces__msg__PolygonObjectArray__Sequence * array = (map_interfaces__msg__PolygonObjectArray__Sequence *)allocator.allocate(sizeof(map_interfaces__msg__PolygonObjectArray__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = map_interfaces__msg__PolygonObjectArray__Sequence__init(array, size);
  if (!success) {
...
map_interfaces__msg__PolygonObjectArray__Sequence__destroy(map_interfaces__msg__PolygonObjectArray__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    map_interfaces__msg__PolygonObjectArray__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
map_interfaces__msg__PolygonObjectArray__Sequence__are_equal(const map_interfaces__msg__PolygonObjectArray__Sequence * lhs, const map_interfaces__msg__PolygonObjectArray__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!map_interfaces__msg__PolygonObjectArray__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  map_interfaces__msg__PolygonObjectArray__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(map_interfaces__msg__PolygonObjectArray);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    map_interfaces__msg__PolygonObjectArray * data =
      (map_interfaces__msg__PolygonObjectArray *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!map_interfaces__msg__PolygonObjectArray__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          map_interfaces__msg__PolygonObjectArray__fini(&output->data[i]);
        }
        return false;
      }
    }
