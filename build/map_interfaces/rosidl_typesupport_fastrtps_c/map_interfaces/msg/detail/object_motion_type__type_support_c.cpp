...
#include "map_interfaces/msg/detail/object_motion_type__rosidl_typesupport_fastrtps_c.h"
...
using _ObjectMotionType__ros_msg_type = map_interfaces__msg__ObjectMotionType;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _ObjectMotionType__ros_msg_type * ros_message = static_cast<const _ObjectMotionType__ros_msg_type *>(untyped_ros_message);
  // Field name: o_motion_type
  {
  ...
  void * untyped_ros_message)
{
  ...
  _ObjectMotionType__ros_msg_type * ros_message = static_cast<_ObjectMotionType__ros_msg_type *>(untyped_ros_message);
  // Field name: o_motion_type
  {
    cdr >> ros_message->o_motion_type;
  }
...
static uint32_t _ObjectMotionType__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_map_interfaces__msg__ObjectMotionType(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = map_interfaces__msg__ObjectMotionType;
    is_plain =
      (
...
static size_t _ObjectMotionType__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_map_interfaces__msg__ObjectMotionType(
...
static message_type_support_callbacks_t __callbacks_ObjectMotionType = {
  "map_interfaces::msg",
  "ObjectMotionType",
...
static rosidl_message_type_support_t _ObjectMotionType__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_ObjectMotionType,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, map_interfaces, msg, ObjectMotionType)() {
  return &_ObjectMotionType__type_support;
}
