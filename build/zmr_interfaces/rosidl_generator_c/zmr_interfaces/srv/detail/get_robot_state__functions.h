...
#ifndef ZMR_INTERFACES__SRV__DETAIL__GET_ROBOT_STATE__FUNCTIONS_H_
#define ZMR_INTERFACES__SRV__DETAIL__GET_ROBOT_STATE__FUNCTIONS_H_
 ...
 * calls
 * zmr_interfaces__srv__GetRobotState_Request__init().
...
/**
 * It calls
 * zmr_interfaces__srv__GetRobotState_Request__fini()
 ...
 * zmr_interfaces__srv__GetRobotState_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * zmr_interfaces__srv__GetRobotState_Request__Sequence__fini()
 * on the array,
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * zmr_interfaces__srv__GetRobotState_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_zmr_interfaces
...
/**
 * It calls
 * zmr_interfaces__srv__GetRobotState_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_zmr_interfaces
...
/**
 * It allocates the memory for the array and calls
 * zmr_interfaces__srv__GetRobotState_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_zmr_interfaces
...
/**
 * It calls
 * zmr_interfaces__srv__GetRobotState_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // ZMR_INTERFACES__SRV__DETAIL__GET_ROBOT_STATE__FUNCTIONS_H_
