...
static const _CurrentFutureStates_type_support_symbol_names_t _CurrentFutureStates_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, zmr_interfaces, msg, CurrentFutureStates)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, zmr_interfaces, msg, CurrentFutureStates)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, zmr_interfaces, msg, CurrentFutureStates)() {
  return &::zmr_interfaces::msg::rosidl_typesupport_c::CurrentFutureStates_message_type_support_handle;
}
