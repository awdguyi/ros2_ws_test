...
def make_mlp(dim_list, activation='relu', batch_norm=True, dropout=0):
    """Make a multi-layer perceptron with the specified properties.

    Args:
        dim_list: A list of numbers of neurons in each layer of the MLP.
        activation: 'relu' or 'leakyrelu'. Defaults to 'relu'.
    """
    layers = []
...
def repeat(tensor: Tensor, num_reps: int):
    """
    Args:
...
class Encoder(nn.Module):
    ...
    def forward(self, obs_traj: Tensor):
        """
        Inputs:
        ...
        obs_traj_embedding: Tensor = self.spatial_embedding(obs_traj.reshape(-1, 2))
...
class TrajectoryGenerator(nn.Module):
    def __init__(
        ...
        """
        Args:
            obs_len: The length of observed trajectory.
            pred_len: The length of predicted trajectory.
            embedding_dim: The dimension of the embedding. Defaults to 64.
            encoder_h_dim: The dimension of the encoder. Defaults to 64.
            decoder_h_dim: The dimension of the decoder. Defaults to 128.
            mlp_dim: The dimension of the mlp. Defaults to 1024.
            num_layers: The number of layers. Defaults to 1.
            noise_dim: The dimension of the noise. Defaults to (0,).
            noise_type: The type of noise, 'gaussian' or 'uniform'. Defaults to 'gaussian'.
            noise_mix_type: The type of noise mix, 'ped' or 'global'. Defaults to 'ped'.
            pooling_type: The type of pooling, 'pool_net' or 'spool'. Defaults to 'none'.
            pool_every_timestep: If pool every timestep. Defaults to True.
            bottleneck_dim: The dimension of the bottleneck. Defaults to 1024.
            activation: The activation function, 'relu' or 'leakyrelu'. Defaults to 'relu'.
            neighborhood_size: The size of the neighborhood. Defaults to 2.0.
            grid_size: The size of the grid. Defaults to 8.
        """
    ...
    def forward(self, obs_traj, obs_traj_rel, seq_start_end, user_noise=None):
        ...
        Args:
            ...
            seq_start_end: A list of tuples which delimit sequences within batch.
            user_noise: Used for inference for seeing relation between different types of noise and outputs.
