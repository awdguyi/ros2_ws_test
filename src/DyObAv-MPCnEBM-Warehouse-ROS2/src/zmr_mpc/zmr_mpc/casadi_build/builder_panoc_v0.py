...
class PanocBuilder:
    ...
    def step_cost(self, step_in_horizon: int, action: ca.SX, last_state: ca.SX,
        ...
        if kt < critical_step:
            ...
            rx_dyn    = dynamic_obstacles[2::self._cfg.ndynobs*(self.N_hor+1)] + self.dynamic_obstacle_enlarge(kt)
            ry_dyn    = dynamic_obstacles[3::self._cfg.ndynobs*(self.N_hor+1)] + self.dynamic_obstacle_enlarge(kt)
        ...
        rx_dyn    = dynamic_obstacles[(kt+1)*self._cfg.ndynobs+2::self._cfg.ndynobs*(self.N_hor+1)] + self.dynamic_obstacle_enlarge(kt)
        ry_dyn    = dynamic_obstacles[(kt+1)*self._cfg.ndynobs+3::self._cfg.ndynobs*(self.N_hor+1)] + self.dynamic_obstacle_enlarge(kt)
