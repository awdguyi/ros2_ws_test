...
class GeometricMap:
    ...
    def __init__(self, boundary_coords: list[tuple[float, float]], 
        ...
        """
        self._boundary_coords:list[tuple[float, float]] = []
    ...
    @property
    def obstacle_coords_list(self) -> list[list[tuple[float, float]]]:
        obs_coords_list = []
    ...
    def id_list(self) -> list[int]:
        return list(self._obstacle_info_dict.keys())
    ...
    @classmethod
    def from_raw(cls, boundary_coords: list[tuple[float, float]], obstacle_coords_list: list[list[tuple[float, float]]]):
    ...
    def register_boundary(self, vertices: list[tuple[float, float]]) -> None:
...
if __name__ == '__main__':
    ...
    obstacle_list = [ObstacleInfo(id_=1, vertices=[(1,1), (2,1), (2,2), (1,2)]), 
                     ObstacleInfo(id_=2, vertices=[(3,3), (4,3), (4,4), (3,4)])
                     ]
